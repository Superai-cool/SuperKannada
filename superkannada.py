...
Original file is located at
    https://colab.research.google.com/drive/14QhK6ufVvUq4qqKzv5uhWeDj7siArbzQ
"""
...
user_language = st.selectbox(
    "Select your language for translation:", ["English", "Hindi", "Tamil", "Telugu", "Malayalam", "Marathi"]
)
...
if query:
    ...
    meaning = translate_text(kannada_translation, src="kn", dest=user_language.lower())
    ...
    st.write(f"**Meaning in {user_language}:** {meaning}")
